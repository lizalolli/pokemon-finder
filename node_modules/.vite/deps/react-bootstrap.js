...
import {
  ...
  require_warning,
  useCol
} from "./chunk-CQS7SSNW.js";
import "./chunk-JUUMRUWO.js";
import {
  require_prop_types
...
function useDropdownMenu(options = {}) {
  const context5 = (0, import_react38.useContext)(DropdownContext_default);
...
function Dropdown({
  ...
  const context5 = (0, import_react43.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
function useTransition({
  ...
  const isInitialRef = (0, import_react52.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react52.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react52.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(Component2, runTransition, props) {
  if (Component2) {
    return (0, import_jsx_runtime62.jsx)(Component2, Object.assign({}, props));
  }
  if (runTransition) {
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react53.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react53.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react53.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react53.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react53.useState)(!show);
  const lastFocusRef = (0, import_react53.useRef)(null);
  (0, import_react53.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react53.useRef)();
  const removeKeydownListenerRef = (0, import_react53.useRef)();
  ...
  return (0, import_jsx_runtime63.jsx)(import_jsx_runtime64.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime65.jsxs)(import_jsx_runtime64.Fragment, {
...
var AbstractModalHeader = React74.forwardRef(({
  ...
  const context5 = (0, import_react54.useContext)(ModalContext_default);
...
var Modal2 = React77.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react55.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react55.useState)(false);
  const waitingForMouseUpRef = (0, import_react55.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react55.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react55.useRef)(null);
  ...
  const renderBackdrop = (0, import_react55.useCallback)((backdropProps) => (0, import_jsx_runtime73.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime73.jsx)("div", {
    ...
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime73.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime73.jsx)(ModalContext_default.Provider, {
    value: modalContext,
...
var Nav2 = React80.forwardRef((uncontrolledProps, ref) => {
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react56.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react56.useContext)(CardHeaderContext_default);
  if (navbarContext) {
...
var NavbarCollapse = React82.forwardRef(({
  ...
  const context5 = (0, import_react57.useContext)(NavbarContext_default);
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react59.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react60.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var Offcanvas = React88.forwardRef(({
  ...
  const modalManager = (0, import_react61.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react61.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react61.useState)(false);
...
var NavbarOffcanvas = React89.forwardRef((props, ref) => {
  const context5 = (0, import_react62.useContext)(NavbarContext_default);
...
var Navbar = React91.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react63.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react63.useMemo)(() => ({
...
var Overlay = React93.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react65.useState)(!props.show);
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react66.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React99.forwardRef(({
  ...
  const popperRef = (0, import_react67.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react67.useState)(null);
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react68.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout2 = useTimeout();
  const hoverStateRef = (0, import_react68.useRef)("");
  ...
  const handleShow = (0, import_react68.useCallback)(() => {
    timeout2.clear();
  ...
  const handleHide = (0, import_react68.useCallback)(() => {
    timeout2.clear();
  ...
  const handleFocus = (0, import_react68.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react68.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react68.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react68.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react68.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime101.jsxs)(import_jsx_runtime100.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react68.cloneElement)(children, triggerProps), (0, import_jsx_runtime99.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var ProgressBar = React105.forwardRef(({
  ...
  return (0, import_jsx_runtime107.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react69.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react70.useContext)(TabContext_default);
  if (!context5)
...
var ToastFade = React118.forwardRef((props, ref) => (0, import_jsx_runtime122.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React120.forwardRef(({
  ...
  const context5 = (0, import_react72.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
